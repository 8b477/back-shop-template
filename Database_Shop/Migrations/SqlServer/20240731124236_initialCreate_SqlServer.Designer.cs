...
namespace Database_Shop.Migrations.SqlServer
{
    ...
    [Migration("20240731124236_initialCreate_SqlServer")]
            ...
            modelBuilder.Entity("Database_Shop.Entity.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Mail = "admin@mail.be",
                            Pseudo = "admin",
                            Pwd = "$2a$11$TLEYWStq1Um2QoP4K4uRfuvJNBkjw3WqdKb.Slm/ZEFXvMFLOJ1g2",
                            Role = "Admin"
                        },
                        new
                        {
                            ...
                            Mail = "user@mail.be",
                            Pseudo = "user",
                            Pwd = "$2a$11$zcj645abT3lUNwAcn5SUQekdKeL1c/SHuvZqNMldvMW9CpbpqNRBm",
                            Role = "User"
                        },
                        new
                        {
                            ...
                            Mail = "user2@mail.be",
                            Pseudo = "user2",
                            Pwd = "$2a$11$Xai40lcmbAfKM3kiLzZFde7Y4y25uX1kWQF3g1hpQN.jIEZLv0Q6G",
                            Role = "User"
                        },
                        new
                        {
                            ...
                            Mail = "user3@mail.be",
                            Pseudo = "user3",
                            Pwd = "$2a$11$R4aHEtvDG7EELrU.b2XO/uQLIG4UkslQ8Dd2eE4tOFkluiZKJQJgy",
                            Role = "User"
                        },
                        new
                        {
                            ...
                            Mail = "user4@mail.be",
                            Pseudo = "user4",
                            Pwd = "$2a$11$oNeu5cH.h5xOuOAGzBsD1enDNb75O4dXUxBw5d5ODa0jRwGrQ31Xe",
                            Role = "User"
                        });
                });
