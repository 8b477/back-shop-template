...
namespace Database_Shop.Migrations.SqlLite
{
    ...
    [Migration("20240731130435_add_relation_articleCategories_SqlLite")]
    partial class add_relation_articleCategories_SqlLite
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Database_Shop.Entity.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Mail = "admin@mail.be",
                            Pseudo = "admin",
                            Pwd = "$2a$11$SiDnPs83LVzP2Q5pI13cwewCyOWJmJu19t60NI3lySFvaLXQbISSi",
                            Role = "Admin"
                        },
                        new
                        {
                            ...
                            Mail = "user@mail.be",
                            Pseudo = "user",
                            Pwd = "$2a$11$AvifplpoceA.XSxyl2Mzp.9pFQVRz5sXm7XZGQT4fOlrMLcM/2GWG",
                            Role = "User"
                        },
                        new
                        {
                            ...
                            Mail = "user2@mail.be",
                            Pseudo = "user2",
                            Pwd = "$2a$11$pf797/44FY5N00X.wh8Cc.b2c1.TS19SwJ587VF0.HXLjlFv6THiq",
                            Role = "User"
                        },
                        new
                        {
                            ...
                            Mail = "user3@mail.be",
                            Pseudo = "user3",
                            Pwd = "$2a$11$c9cGjaiTgDx5iu3v1gQ1y.f2fgdOeFVHg4N4.kTsBMIrMPEsMAGLu",
                            Role = "User"
                        },
                        new
                        {
                            ...
                            Mail = "user4@mail.be",
                            Pseudo = "user4",
                            Pwd = "$2a$11$O1utu.IW27QNdRkgu4H.D.ZP0szwyDJFEmw8MSpSLyPfRL2RiZx.S",
                            Role = "User"
                        });
                });
