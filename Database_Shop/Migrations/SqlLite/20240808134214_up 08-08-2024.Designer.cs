            ...
            modelBuilder.Entity("Database_Shop.Entity.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Mail = "admin@mail.be",
                            Pseudo = "admin",
                            Pwd = "$2a$11$dQKz8GZmD3QDWRAjyMXr6u1ed5GKPOwZYuNCKzeGcWRHzPPXBmxvS",
                            Role = "Admin"
                        },
                        new
                        {
                            ...
                            Mail = "user@mail.be",
                            Pseudo = "user",
                            Pwd = "$2a$11$Pu7EDwijYrWwSZK2HAoD0ew4kQ/RVFXEOWxX3pWdfIiHis0u6AVwy",
                            Role = "User"
                        },
                        new
                        {
                            ...
                            Mail = "user2@mail.be",
                            Pseudo = "user2",
                            Pwd = "$2a$11$6ESg.JOT64bO0msL5jAFMOSKaHAQT1qiNLcOUdFnfZKm/sBiXQV/S",
                            Role = "User"
                        },
                        new
                        {
                            ...
                            Mail = "user3@mail.be",
                            Pseudo = "user3",
                            Pwd = "$2a$11$WNxRJJWKpwIK.fF7UtvqduJ1dVoTA0dkwTuyrbPbz6.4XWLSO5Sza",
                            Role = "User"
                        },
                        new
                        {
                            ...
                            Mail = "user4@mail.be",
                            Pseudo = "user4",
                            Pwd = "$2a$11$PPECv0iWguY0yvUPdfS0bex9k12hlmcnVsMCJhx6L3TSHrqg5nHpm",
                            Role = "User"
                        });
                });
