...
namespace Database_Shop.Migrations.SqlLite
{
    ...
    [Migration("20240731124134_initialCreate_SqlLite")]
    partial class initialCreate_SqlLite
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Database_Shop.Entity.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Mail = "admin@mail.be",
                            Pseudo = "admin",
                            Pwd = "$2a$11$zUTr7KxjScu7I0NhJhkeQ./jXN0iwMZxFh25RwECzSuZ8V5YWXdya",
                            Role = "Admin"
                        },
                        new
                        {
                            ...
                            Mail = "user@mail.be",
                            Pseudo = "user",
                            Pwd = "$2a$11$RZ1sro3AxQCUV8Vab0U1GO7mpaG/Zar7TyHiNqKqpRA64l9sb3vre",
                            Role = "User"
                        },
                        new
                        {
                            ...
                            Mail = "user2@mail.be",
                            Pseudo = "user2",
                            Pwd = "$2a$11$NdQskB2Oq6S6Y81raiIwaOQifYaGPoKDsyXQuCcSY49CYXgik//H2",
                            Role = "User"
                        },
                        new
                        {
                            ...
                            Mail = "user3@mail.be",
                            Pseudo = "user3",
                            Pwd = "$2a$11$OGtV0XH4hOtxeR6awMcaIuQV4/yHmPFLL5O78mA3Ne2JbuR37e2y.",
                            Role = "User"
                        },
                        new
                        {
                            ...
                            Mail = "user4@mail.be",
                            Pseudo = "user4",
                            Pwd = "$2a$11$EEZew34crZuPiM5qFilBg.Azbac1MTk5w555taHQs.f7dDqsIQh9a",
                            Role = "User"
                        });
                });
